        ...
        <nav class="bg-gray-800">
                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-8"
                                src="https://oualidsenina.com/static/media/logo_svg.071201195a3c98a9cef7eb2dfac17f5e.svg"
                                alt="Your Company">
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="/jobs"
                        class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Jobs</a>
                    <a href="/contact"
